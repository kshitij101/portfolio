        ...
        <div className="flex flex-col gap-2 md:flex-row w-full mx-auto rounded-xl bg-darkblue p-4 md:gap-7 lg:gap-9 lg:rounded-2xl xl:gap-10">
          <div className="p-2 w-full text-center lg:p-5 xl:p-7 md:w-1/2 lg:w-4/6">
            <h1
              ...
              data-aos-once="false"
              className="hidden md:block text-2xl lg:text-3xl text-cyan font-medium mb-3 lg:mb-4"
            >
              Get In Touch
            </h1>
            <div
          ...
          >
            ...
            <div
              ...
              className="p-2 w-full"
            >
              <button className=" font-medium mx-auto my-3 text-black bg-cyan border-0 py-2 px-12 focus:outline-none hover:scale-110 hover:bg-orange-600 transition duration-500 rounded-xl text-lg">
                Send
              </button>
            </div>
          </form>
